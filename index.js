...
const { checkVariableInComputation } = require("./validations");
...
var _engine = {
  ...
  express: function (opts) {
    ...
    return function (filePath, ctx, callback) {
      assert(
        Array.isArray(this.root) || _.isString(this.root),
...
function factory(options) {
  ...
  engine.checkVariableInComputation = function (expression) {
    return checkVariableInComputation(this, expression);
  };
